...
export default function SettingsPage({ workspace, storageUsedMb, onOpenApiKeys, onWorkspaceNameChange, onDirtyChange, onSaveSuccess, leaveRequest, onLeaveResolved }: SettingsPageProps) {
      ...
      <div className="settingsLayout">
        ...
        <div className="settingsContent">
          ...
          <section className="settingsGroup" id="general"><header><h2>General</h2></header>
            ...
            <Row label="Your role"><span className="workspaceRoleBadge">{workspace.role}</span></Row>
