...
export default function CreateWorkspacePage({ existingNames, onCancel, onCreate }: CreateWorkspacePageProps) {
  ...
  return <main className="createWorkspacePage" aria-labelledby="create-workspace-title">
    ...
    <form className="createWorkspaceBody" onSubmit={submit} noValidate>
      ...
      <footer className="createWorkspaceActions"><button type="button" onClick={requestCancel}>Cancel</button><button className="createWorkspaceSubmit" type="submit" disabled={isSubmitting} aria-busy={isSubmitting}><img src="/assets/workspace-menu-add.svg" alt="" />Create workspace</button></footer>
    </form>
  </main>
}
